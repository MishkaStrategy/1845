...
For every non-trivial task in `MishkaStrategy/1845`, load the current `main` version of `MishkaStrategy/.github/AI_AGENT_POLICY.md` once for the current working session.
